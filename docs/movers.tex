...
\code{cause\_gives} and \code{extra\_gives2} have the shape they do.
...
\code{extra\_gives2}, and it is the one rule in this development most easily
...
does not own it needs a way to get at \code{extra} from code, and until recently
...
\code{extra\_gives2} must mention only \code{c} and the two messages, for the
